...
module.exports = {getId, getScore, initApi, playerData, getContestData, initializeApplication, initializeDatabase, 
                  sqlitePromise, getPlayerData, initUser, isRegistered, updateState, getCurrentState, registerTitle, 
                  updateNetworkName, updateId, retrieveIdLocal, api};
